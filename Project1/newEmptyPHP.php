...
echo "<br>";
echo $_SERVER['HTTP_ACCEPT'].'itpriprtyipiyp';
echo "<br>";
...
function is_useragent_mobile($useragent)
{
...
if(is_useragent_mobile($user_agent)) 
{
    echo "Mobile browsing";
} 
else 
{
    echo "Desktop browsing";
}
?>
